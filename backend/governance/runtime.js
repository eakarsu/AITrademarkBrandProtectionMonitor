function validateRuntime(env = process.env) {
  ...
  if (mode === 'production') {
    ...
    if (env.ALLOW_MOCK_PROVIDERS === 'true' || env.ALLOW_DEMO_SEED === 'true' || env.ENABLE_DEMO_TELEMETRY === 'true' || env.ENABLE_LEGACY_SCHEMA_BOOTSTRAP === 'true' || env.ENABLE_LEGACY_PROVIDER_ROUTES === 'true') {
